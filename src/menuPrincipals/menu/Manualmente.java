 ...
 */
public class Manualmente extends javax.swing.JFrame {

    /**
     * Creates new form Manualmente
     */
    public Manualmente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manualmente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manualmente().setVisible(true);
            }
        });
    }
